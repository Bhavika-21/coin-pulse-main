    ...
    return (
        <div className='wrapper'>
            ...
            animate end position where to sit ,transition --duration of animate ,delay */}
                ...
                transition={{duration:0.9}}>Your Ultimate</motion.h1>
                <motion.h1 className='bigheading2'
                initial={{y:50,opacity:0}} 
                animate={{y:0,opacity:1}}
                transition={{duration:0.5,delay:0.25}}>Coin Tracker</motion.h1>

                <motion.p className='para' initial={{y:50,opacity:0}} 
                animate={{y:0,opacity:1}}
                transition={{duration:0.5,delay:0.75}}   >Track your crypo through a public api in real time.  Headover to dasboards:)</motion.p>
